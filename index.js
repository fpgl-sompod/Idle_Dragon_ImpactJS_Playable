        ...
        EntityGameControl = ig.Entity.extend({
            ...
            drawDragonArrow: function () {
                if (MJS.view.viewport.orientation.portrait) {
                    ...
                    b.translate(510, this.dragonArrowYLand);
                    //b.scale(0.1, 0.1);
                    this.imageTutorialArrow.draw(0, 0);
                    b.restore();
                }
            ...
            drawCart: function () {
                ...
                if (MJS.view.viewport.orientation.portrait) {
                    ...
                    var b = ig.system.context;
                    b.save();
                    b.translate(this.cartXLand, 155);
                    b.scale(1.2, 1);
                    this.imageCart.draw(0, 0);
                    b.restore();
                    ...
                    b.save();
                    b.fillStyle = "#FFFFFF";
                    b.font = "30px curse-casual";
                    b.textAlign = "center";
                    b.translate(this.cartXLand - 105, 185);
                    b.lineWidth = 3;
                    b.fillText(this.cartTotalCoin, 150, 0);
                    b.restore();
                }
            ...
            drawEarthDragon: function () {
                if (MJS.view.viewport.orientation.portrait) {
                    ...
                    var b = ig.system.context;
                    b.save();
                    b.translate(this.earthDragonXLand + this.imageEarthDragon.width * 0.12 / 2, 273 + this.imageEarthDragon.height * 0.12);
                    b.scale(0.12 * this.scaleMonster1.x, 0.12 * this.scaleMonster1.y);
                    if (this.isDragonLeft == 1) {
                        this.imageEarthDragon.draw(-this.imageEarthDragon.width / 2, -this.imageEarthDragon.height);
                    } else {
                        this.imageEarthDragon1.draw(-this.imageEarthDragon1.width / 2, -this.imageEarthDragon1.height);
            ...
            drawDragon2nd: function () {
                if (MJS.view.viewport.orientation.portrait) {
                    ...
                    var b = ig.system.context;
                    b.save();
                    var x = this.imageDragon2nd.width * 0.12 / 2;
            ...
            UnlockCellClick: function () {
                ...
                {
                    if (ig.input.mouse.x >= 250 && ig.input.mouse.x <= 341) {
                        if (ig.input.mouse.y >= 159 && ig.input.mouse.y <= 204) {
                            ig.input.mouse.x = 0;
                            ig.input.mouse.y = 0;
                            if (this.isUnlockCell == 0) {
                                this.isUnlockCell = 1;
            ...
            CoinThrowAnim: function () {
                if (MJS.view.viewport.orientation.portrait) {
                    ...
                    //coin 0
                    this.tween({ singleCoin16Y: 5, singleCoin16X: 380}, 1, {
                        easing: ig.Tween.Easing.Back.EaseIn,
                        onComplete: function () {
                    ...
                    setTimeout(() => {
                        //coin 1
                        this.tween({ singleCoin17Y: 5, singleCoin17X: 380}, 1, {
                            easing: ig.Tween.Easing.Back.EaseIn,
                            onComplete: function () {
                    ...
                    setTimeout(() => {
                        //coin 2
                        this.tween({ singleCoin18Y: 5, singleCoin18X: 380}, 1, {
                            easing: ig.Tween.Easing.Back.EaseIn,
                            onComplete: function () {
                    ...
                    setTimeout(() => {
                        //coin 3
                        this.tween({ singleCoin19Y: 5, singleCoin19X: 380}, 1, {
                            easing: ig.Tween.Easing.Back.EaseIn,
                            onComplete: function () {
                    ...
                    setTimeout(() => {
                        //coin 4
                        this.tween({ singleCoin20Y: 5, singleCoin20X: 380}, 1, {
                            easing: ig.Tween.Easing.Back.EaseIn,
                            onComplete: function () {
                    ...
                    setTimeout(() => {
                        //coin 5
                        this.tween({ singleCoin21Y: 5, singleCoin21X: 380}, 1, {
                            easing: ig.Tween.Easing.Back.EaseIn,
                            onComplete: function () {
                                this.totalCoin = "2k";
                                this.isCoinThrowAnim = 0;
            ...
            EarthDragonClickCall: function () {
                if (MJS.view.viewport.orientation.portrait) {
                    ...
                    if (ig.input.mouse.x >= 246 && ig.input.mouse.x <= 304) {
                        if (ig.input.mouse.y >= 171 && ig.input.mouse.y <= 222) {
                            //console.log(ig.input.mouse.x + ' ' + ig.input.mouse.y);
                            ig.input.mouse.x = 0;
                            ig.input.mouse.y = 0;
                            if (this.isDragonLeft == 0) {
            ...
            Dragon2ndClickCall: function () {
                ...
                if (MJS.view.viewport.orientation.portrait) {
                    ...
                    if (ig.input.mouse.x >= 256 && ig.input.mouse.x <= 379) {
                        if (ig.input.mouse.y >= 238 && ig.input.mouse.y <= 422) {
                            ig.input.mouse.x = 0;
                            ig.input.mouse.y = 0;
                            this.isDragon2ndUnlock = 1;
                            this.isTutorialHand1Showing = 0;
